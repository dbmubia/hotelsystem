...
public class BookingUI {
	...
	public void displayBookingDetails(String roomDescription, Date arrivalDate, int stayLength, double cost) {
        ...
        public void displayCreditDetails(CreditCardType type,int number,int ccv){
            String outputStr = String.format(
				"\nThe card vendor is %s The card number is %d and the ccv is %d",
				type.getVendor(),number,ccv);
				
		IOUtils.outputln(outputStr);
        }
        
	public void displayConfirmedBooking(String roomDescription, int roomNumber,
